(function () {
    ...
    const resultDvided = document.getElementById('result-area');
    ...
    assessmentButton.onclick = () => {
        ...
        if (userName.length === 0) { // 名前が空の時はしょりを終了する 
            return;
        }
    
      
        // 診断結果表示エリアの作成
        removeAllChildren(resultDvided);        
    ...
    console.assert(
        assessment('太郎') === assessment('太jirou郎'),
        'しっぱい'
    );
})();
